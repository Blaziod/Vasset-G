  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <h1 style={{ color: "#007A25", fontSize: "44px", fontWeight: "600" }}>
            Safe & fastest way to Manage your Assets
          </h1>
          <h1 style={{ color: "#707A8A", fontSize: "18px", fontWeight: "400" }}>
          ...
          <p className="text-center text-[#0b5530] mb-2 font-bold">OR</p>
          <button
            className="w-full flex items-center justify-center py-2 mb-4 border rounded-md bg-white text-[#22242A] text-[16px] hover:bg-gray-200"
      ...
      >
        ...
        >
          ...
          <h1 style={{ color: "#22242A", fontSize: "35px", fontWeight: "600" }}>
