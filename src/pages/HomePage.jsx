    ...
    <>
      ...
      >
        {!isSmallScreen && (
          ...
          >
            ...
            >
              ...
              >
                Safe & fastest way to Manage your Virtual Assets
              </p>
              <p
                style={{
                  color: "#707A8A",
          ...
          >
            <Column>
              ...
              <h1 style={{ ...textStyle, fontSize: "14px" }}>
                Let our experts handle your virtual assets seamlessly. From
                buying to selling and portfolio management, trust us to maximize
                your returns.
              </h1>
            </Column>
            <Column>
            ...
            <Column>
              ...
              <h1 style={{ ...textStyle, fontSize: "14px" }}>
                ...
                tailored trust funds management services, ensuring your assets
                are preserved and distributed according to your wishes.
              </h1>
            </Column>
          </div>
          <div
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                All the way from Houston, Texas . Choosing Vasset for my
                property management was one of the best decisions I have made!
                living in the diaspora, I was so concerned about how to
                effectively, manage my property back home, sometimes in March
                this year I was introduced to Vasset&apos;s service and this has
                made things so easy. They provided a steady stream of income
                while handling all the tenants and maintenance issues. The team
                is professional responsive and knows how to maximize property
                value. Now I can enjoy consistent returns without any worries.
                Vassset Global is highly recommended.
              </p>
            </div>
            ...
            >
              ...
              >
                ...
                keep for my kids. and thanks to them for coming through to get
                me a loan when i needed it without selling my assets.
              </p>
            </div>
        ...
        >
          ...
          >
            <p
              style={{ color: "#707A8A", fontSize: "14px", fontWeight: "400" }}
            >
              Benefits
            </p>
            <h1
            ...
            >
              Seamlessly buy and sell cryptocurrency through bank accounts,
              credit cards, debit cards, online wallets and various other
              methods.
            </p>
          </div>
          <div
